...
public class Menu_Calendario extends Estado
{
    ...
    public void inicializa_Calendario()
    {
        ...
        for(int i=0;i<7;i++)
        {
            ...
            dia[i].setTamanhoBloco(largura,largura);
            dia[i].setPosicao(x+largura/2, y);
    ...
    public void atualizaCalendario(int adi)
    {
        ...
        if(novo > 0 && novo < 13){
            ...
            mes.setPosicao(gerenciador.getLargura()/2, gerenciador.getAltura()*22/100);
        }
    }
